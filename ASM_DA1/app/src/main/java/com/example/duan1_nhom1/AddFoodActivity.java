...
public class AddFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodTypeDAO = new FoodTypeDAO(AddFoodActivity.this);
    ...
    private void uploadFirebaseStogare() {
        ...
        if(edtName.getText().toString().isEmpty() || edtPrice.getText().toString().isEmpty() || edtDescribe.getText().toString().isEmpty()){
            Toast.makeText(AddFoodActivity.this, "Please enter enough information", Toast.LENGTH_SHORT).show();
            return;
        }
        Date date = new Date();
