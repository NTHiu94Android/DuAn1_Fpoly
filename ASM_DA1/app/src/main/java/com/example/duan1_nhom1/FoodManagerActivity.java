...
public class FoodManagerActivity extends AppCompatActivity {
    ...
    private void getData(){
        ...
        foodAdapter.getData(list, FoodManagerActivity.this);
        LinearLayoutManager manager = new LinearLayoutManager(FoodManagerActivity.this);
        manager.setOrientation(RecyclerView.VERTICAL);

        rcv.setAdapter(foodAdapter);
        rcv.setLayoutManager(manager);

        RecyclerView.ItemDecoration itemDecoration = new DividerItemDecoration(FoodManagerActivity.this, DividerItemDecoration.VERTICAL);
