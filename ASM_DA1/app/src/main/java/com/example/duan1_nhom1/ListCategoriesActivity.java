...
import com.example.duan1_nhom1.adapter.ListFoodCategoriesAdapter;
...
public class ListCategoriesActivity extends AppCompatActivity {
    ...
    private ListFoodCategoriesAdapter adapter;
    private TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set data len rcv
        adapter = new ListFoodCategoriesAdapter();
        adapter.getData(listFood, ListCategoriesActivity.this);
