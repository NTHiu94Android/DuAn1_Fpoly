...
public class RestaurantDetailResActivity extends AppCompatActivity {
    ...
    private void initListener(){
        layout_QLDH.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RestaurantOrderManagerActivity.class);
        ...
        layout_LSDH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), RestaurantHistoryOrderActivity.class);
                intent.putExtra("maNH", restaurant.getMaNH());
                startActivity(intent);
            }
        });
        ...
        layout_QLTK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RestaurantDetailResActivity.this, RestaurantOwnerInforActivity.class);
