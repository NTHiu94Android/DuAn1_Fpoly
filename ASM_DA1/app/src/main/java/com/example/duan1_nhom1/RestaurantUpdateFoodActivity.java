...
public class RestaurantUpdateFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maNH = food.getMaNH();
        foodTypeDAO = new FoodTypeDAO(RestaurantUpdateFoodActivity.this);
        addSpinner();
    ...
    //Anh xa view
    private void initUi() {
        edtName = findViewById(R.id.edtUpdateNameFood);
        edtDescribe = findViewById(R.id.edtUpdateDescribeFood);
        edtPrice = findViewById(R.id.edtUpdatePriceFood);
        spinner = findViewById(R.id.spnUpdateFoodType);
        imv = findViewById(R.id.imvUpdateFood);
        btnUpdate = findViewById(R.id.btnUpdateFood);
        btnCancel = findViewById(R.id.btnCancelUpdateFood);
    }
    ...
    private void uploadFirebaseStogare() {
        ...
        if(edtName.getText().toString().isEmpty() || edtPrice.getText().toString().isEmpty() || edtDescribe.getText().toString().isEmpty()){
            Toast.makeText(RestaurantUpdateFoodActivity.this, "Please enter enough information", Toast.LENGTH_SHORT).show();
            return;
        }
        Date date = new Date();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                mountainsRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        FoodDAO foodDAO = new FoodDAO(RestaurantUpdateFoodActivity.this);
                        foodDAO.update(food);
                        myRef.child(String.valueOf(food.getMaMA())).setValue(food, new DatabaseReference.CompletionListener() {
                            @Override
                            public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                                if(error == null){
                                    Toast.makeText(RestaurantUpdateFoodActivity.this, "Update food succsess", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(getApplicationContext(), RestaurantFoodManagerActivity.class);
                                    intent.putExtra("maNH", maNH);
                                    startActivity(intent);
                                    finish();
                                }else {
                                    Toast.makeText(RestaurantUpdateFoodActivity.this, "Update food fail", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
